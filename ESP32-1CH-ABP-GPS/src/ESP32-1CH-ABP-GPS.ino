...
HardwareSerial ss(1);    // UART1/Serial1
#define RXD2 12
#define TXD2 13
...
// Pin mapping for the TTGO ESP32 LoRa 1-CH Gateway
...
void do_send(osjob_t* j) {
  ...
  if (LMIC.opmode & OP_TXRXPEND) {
    ...
    LMIC_setTxData2(1, coords, sizeof(coords) - 1, 0);
...
void saveGPS() {
  if (gps.location.isValid()) {
    ...
    altitudeGPS = gps.altitude.meters(); // int16_t
    hdopGPS = gps.hdop.value(); 
  };
